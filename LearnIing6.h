...
//This program is only for high-dim: 25, 50, and 104 dimensions
//Note: Change COL_NUM, DIS_NUM, Top-N , max server memory, THRESHOLD_KB //, iNumUpdateKB//,

#define COL_NUM		    128//104 //50 //25    /-- old //50 //25 //4 //3 //4 //50 //25 //2 -- //3 //4 //25 //--//4 //104 //3 //2 //3 //4 //25 //50 //104 //2  	//zl for LSI SAME CASE
#define DIS_NUM           2 //-1 //2 //1 == L1; 2 == L2; -1 =Linf distances
#define WORKLOAD_NUM	1000//2000 //400 //2000//1000//400    //... //100 //909  //100
#define MAX_SVR_MEM	     8 //4 //8 //4 //8
#define THRESHOLD_KB   1410   //2000  //1261     //1310      //1410       //2000 
                              //<=4D  //25D      //50D       //104D       //2D 
#define TOP_N    20 //80 //200 //Lsi50  10 //80 //200 //Lsi25 10 //80 //200      

//#define THRESHOLD_KB          //2000  //1261     // 1310      //1410       //2000 
                                //<=4D  //25D      //50D       //104D         //2D 

//we determine that the maximum size of P will be 2000 for each low-dimensional dataset, 
    //1261, 1310, and 1410 for Lsi25D, Lsi50D and Lsi104D respectively. 
// we configure the 'max server memory' to be 8MB for both Lsi50D and Lsi104D,
	// and 4MB for the other datasets.
...
extern struct  TUPLE * tInD;       //all tuples from DataSet 2015.7.29 songxin
...
struct ProfileMP
{
	...
	int * pTID;  // the TopN-tuple ID, i.e., that points the ID of  the top-N tuples of the profile Query.      // 2015.7.29 zl 
};
...
public:
    ...
    int clsNum; // the number of lusters
...
public:
	...
	int zlPartion3D1(ZLRECT Rect, int Dimention, ZLRECT * T, int T_Num, int PartNum);
	int zlPartion3D(ZLRECT * Rect, int Dimention, ZLRECT * T, int T_Num, int PartNum);
